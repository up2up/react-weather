            ...
            <div className="temp s-block">
              <div className="main-temp s-grid direction-column">
                <div className="secondary-temp">
                  <span className="s-block">H {convertFahrenheitToCelsius(item.temperatureMax)}<i className="wi wi-celsius"></i></span>
                  <span className="s-block">L {convertFahrenheitToCelsius(item.temperatureMin)}<i className="wi wi-celsius"></i></span>
                </div>
